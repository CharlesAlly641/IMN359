...
mandrill = loadmat("mandrill.mat")['mandrill']
...
def approximation_fourier_nonlineaire(image, M_values):
    ...
    for i, M in enumerate(M_values):
        ...
        axs[i].axis('off')
    plt.savefig('3_mandrill_fourier.jpg')
...
approximation_fourier_nonlineaire(mandrill, M_valeurs)
...
def approximation_dct_nonlineaire(image, M_values):
    ...
    plt.savefig('3_mandrill_dct.jpg')
...
approximation_dct_nonlineaire(mandrill, M_valeurs)
...
def approximation_dct_locale_nonlineaire(image, M_values, block_size):
    ...
    plt.savefig('3_mandrill_dctloc.jpg')
...
approximation_dct_locale_nonlineaire(mandrill, M_valeurs, 32)
...
def approximation_ondelettes_nonlineaire(image, M_values, Jmax, Jmin):
    ...
    plt.savefig('3_mandrill_ondelettes.jpg')
    plt.show()

approximation_ondelettes_nonlineaire(mandrill, M_valeurs, 9, 1)